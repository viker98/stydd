...
class ThreeJntChain:
    ...
    def RigThreeJntChain(self):
        ...
        CreatePlus(ikfkBlendCtrl,self.controllerSize)
...
#set up a color button that changes the colors of the curves its under display then drawing overides look at mel editor to see what to do :3
